...
public class JerseyRemoteRegionClientFactory implements TransportClientFactory {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(JerseyRemoteRegionClientFactory.class);
  ...
  @Inject
  public JerseyRemoteRegionClientFactory(
  ...
  public EurekaHttpClient newClient(EurekaEndpoint endpoint) {
    return new JerseyApplicationClient(
        getOrCreateJerseyClient(region, endpoint).getClient(),
    ...
    synchronized (lock) {
      if (jerseyClient == null) {
        ...
        if (endpoint.isSecure()) {
          ...
          clientBuilder
              .withClientName("Discovery-RemoteRegionSystemSecureClient-" + region)
              .withSystemSSLConfiguration();
        } else {
          clientBuilder
              .withClientName("Discovery-RemoteRegionSecureClient-" + region)
              .withTrustStoreFile(
