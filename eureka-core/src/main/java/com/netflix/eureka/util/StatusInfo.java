...
public class StatusInfo {
  ...
  private static final boolean ARCHAIUS_EXISTS =
      classExists("com.netflix.config.ConfigurationManager");

  public static final class Builder {

    @XStreamOmitField private StatusInfo result;
    ...
    /** Build the {@link StatusInfo}. General information are automatically built here too. */
    public StatusInfo build() {
      ...
      if (ARCHAIUS_EXISTS) {
        result.generalStats.put(
            "environment", ConfigurationManager.getDeploymentContext().getDeploymentEnvironment());
      }
  ...
  public boolean isHealthy() {
    return isHeathly != null && isHeathly.booleanValue();
  }
