...
public class InstanceResource {
    ...
    @PUT
    @Path("status")
    public Response statusUpdate(@QueryParam("value") @Nullable String newStatus, @HeaderParam(PeerEurekaNode.HEADER_REPLICATION) String isReplication, @QueryParam("lastDirtyTimestamp") String lastDirtyTimestamp) {
        try {
