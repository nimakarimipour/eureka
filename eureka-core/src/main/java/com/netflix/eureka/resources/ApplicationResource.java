...
public class ApplicationResource {
    ...
    ApplicationResource(@Nullable String appName, EurekaServerConfig serverConfig, PeerAwareInstanceRegistry registry) {
    ...
    public Response addInstance(@Nullable InstanceInfo info, @HeaderParam(PeerEurekaNode.HEADER_REPLICATION) String isReplication) {
