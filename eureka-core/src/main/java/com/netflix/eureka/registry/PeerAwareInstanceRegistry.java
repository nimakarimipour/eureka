...
public interface PeerAwareInstanceRegistry extends InstanceRegistry {
   ...
   * period specified in {@link
   * com.netflix.eureka.EurekaServerConfig#getWaitTimeInMsWhenSyncEmpty()}, if it cannot get the
   * registry information from the peer eureka nodes at start up.
   *
  ...
  void statusUpdate(
      final String asgName, final ASGResource.ASGStatus newStatus, final boolean isReplication);
}
