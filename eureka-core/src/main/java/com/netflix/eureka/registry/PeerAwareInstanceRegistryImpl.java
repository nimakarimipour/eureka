...
public class PeerAwareInstanceRegistryImpl extends AbstractInstanceRegistry implements PeerAwareInstanceRegistry {
     ...
     */
    @Override
    public boolean cancel(final String appName, @Nullable final String id, final boolean isReplication) {
     ...
     * java.lang.String, long, boolean)
     */
    public boolean renew(final String appName, @Nullable final String id, final boolean isReplication) {
     ...
     */
    @Override
    public boolean statusUpdate(final String appName, @Nullable final String id, final InstanceStatus newStatus, @Nullable String lastDirtyTimestamp, final boolean isReplication) {
    ...
    @Override
    public boolean deleteStatusOverride(String appName, @Nullable String id, InstanceStatus newStatus, String lastDirtyTimestamp, boolean isReplication) {
     ...
     */
    private void replicateToPeers(Action action, String appName, @Nullable String id, @Nullable InstanceInfo info, /* optional */
     ...
     */
    private void replicateInstanceActionsToPeers(Action action, String appName, @Nullable String id, @Nullable InstanceInfo info, @Nullable InstanceStatus newStatus, PeerEurekaNode node) {
        try {
