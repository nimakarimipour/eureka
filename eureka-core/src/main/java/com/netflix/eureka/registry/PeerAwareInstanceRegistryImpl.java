...
public class PeerAwareInstanceRegistryImpl extends AbstractInstanceRegistry implements PeerAwareInstanceRegistry {
     ...
     */
    @Override
    public boolean statusUpdate(final String appName, final String id, final InstanceStatus newStatus, @Nullable String lastDirtyTimestamp, final boolean isReplication) {
     ...
     */
    private void replicateToPeers(Action action, String appName, String id, @Nullable InstanceInfo info, /* optional */
     ...
     */
    private void replicateInstanceActionsToPeers(Action action, String appName, String id, @Nullable InstanceInfo info, @Nullable InstanceStatus newStatus, PeerEurekaNode node) {
        try {
