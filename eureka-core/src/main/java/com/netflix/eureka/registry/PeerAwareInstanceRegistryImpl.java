...
public class PeerAwareInstanceRegistryImpl extends AbstractInstanceRegistry
  ...
  public PeerAwareInstanceRegistryImpl(
    ...
    this.instanceStatusOverrideRule =
        new FirstMatchWinsCompositeRule(
            ...
            new LeaseExistsRule());
    this.peerEurekaNodes = initializePeerEurekaNodes();
  }

  private PeerEurekaNodes initializePeerEurekaNodes() {
    // Custom logic to initialize peerEurekaNodes
    return new PeerEurekaNodes(/* necessary arguments */ );
  }
  ...
  private void replicateToPeers(
    ...
    try {
      ...
      // If it is a replication already, do not replicate again as this will create a poison
      // replication
