...
public abstract class AbstractInstanceRegistry implements InstanceRegistry {
     ...
     */
    @Override
    public boolean statusUpdate(String appName, @Nullable String id, InstanceStatus newStatus, @Nullable String lastDirtyTimestamp, boolean isReplication) {
        read.lock();
        try {
    ...
    @Nullable
    protected InstanceInfo.InstanceStatus getOverriddenInstanceStatus(InstanceInfo r, @Nullable Lease<InstanceInfo> existingLease, boolean isReplication) {
