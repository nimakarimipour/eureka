...
public abstract class AbstractInstanceRegistry implements InstanceRegistry {
    ...
    if (includeRemoteRegion) {
      for (String remoteRegion : remoteRegions) {
        ...
        if (null != remoteRegistry) {
          ...
          if (remoteApps != null) { // Add null check here
  ...
  public Applications getApplications(boolean includeRemoteRegion) {
    ...
    if (includeRemoteRegion) {
      for (RemoteRegionRegistry remoteRegistry : this.regionNameVSRemoteRegistry.values()) {
        ...
        if (applications != null) { // Added null check here
   ...
   * The remote regions from where the instances will be chosen can further be restricted if this
