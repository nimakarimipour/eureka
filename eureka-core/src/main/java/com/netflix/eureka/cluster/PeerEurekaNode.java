...
public class PeerEurekaNode {
     ...
     * @throws Throwable
     */
    public void heartbeat(final String appName, @Nullable final String id, final InstanceInfo info, @Nullable final InstanceStatus overriddenStatus, boolean primeConnection) throws Throwable {
        if (primeConnection) {
     ...
     */
    public void statusUpdate(final String appName, @Nullable final String id, @Nullable final InstanceStatus newStatus, final InstanceInfo info) {
        long expiryTime = System.currentTimeMillis() + maxProcessingDelayMs;
     ...
     *            the instance information of the instance.
     */
    public void deleteStatusOverride(final String appName, @Nullable final String id, final InstanceInfo info) {
        long expiryTime = System.currentTimeMillis() + maxProcessingDelayMs;
     ...
     */
    private void syncInstancesIfTimestampDiffers(String appName, @Nullable String id, InstanceInfo info, InstanceInfo infoFromPeer) {
        try {
