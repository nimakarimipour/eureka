...
public class ReplicationInstance {
    ...
    @JsonCreator
    public ReplicationInstance(@JsonProperty("appName") String appName, @JsonProperty("id") @Nullable String id, @JsonProperty("lastDirtyTimestamp") Long lastDirtyTimestamp, @JsonProperty("overriddenStatus") @Nullable String overriddenStatus, @JsonProperty("status") @Nullable String status, @JsonProperty("instanceInfo") InstanceInfo instanceInfo, @JsonProperty("action") @Nullable Action action) {
