...
public class AbstractVIPResourceTest extends AbstractTester {
  ...
  public void setUp() throws Exception {
    ...
    resource =
        new AbstractVIPResource(serverContext) {
          @Override
          protected Response getVipResponse(
            ...
            return super.getVipResponse(
                version, entityName, acceptHeader, eurekaAccept, entityType);
          }
        };
    ...
    for (InstanceInfo instanceInfo : testApplication.getInstances()) {
      InstanceInfo changed =
          new InstanceInfo.Builder(instanceInfo)
