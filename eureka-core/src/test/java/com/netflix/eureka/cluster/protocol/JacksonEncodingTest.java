...
public class JacksonEncodingTest {
  ...
  public void testReplicationInstanceResponseEncoding() throws Exception {
    ReplicationInstanceResponse replicationInstanceResponse =
        ClusterSampleData.newReplicationInstanceResponse(true);

    // Encode / decode
    String jsonText = jacksonCodec.writeToString(replicationInstanceResponse);
    ReplicationInstanceResponse decodedValue =
        jacksonCodec.readValue(ReplicationInstanceResponse.class, jsonText);
  ...
  public void testReplicationListResponseEncoding() throws Exception {
    ...
    ReplicationListResponse decodedValue =
        jacksonCodec.readValue(ReplicationListResponse.class, jsonText);
