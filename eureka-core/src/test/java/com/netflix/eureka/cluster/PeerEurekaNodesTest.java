...
public class PeerEurekaNodesTest {
  ...
  private final TestablePeerEurekaNodes peerEurekaNodes =
      new TestablePeerEurekaNodes(registry, ClusterSampleData.newEurekaServerConfig());
  ...
  static class TestablePeerEurekaNodes extends PeerEurekaNodes {
    ...
    private AtomicReference<List<String>> peerUrlsRef =
        new AtomicReference<>(Collections.<String>emptyList());
    private final ConcurrentHashMap<String, PeerEurekaNode> peerEurekaNodeByUrl =
    ...
    protected PeerEurekaNode createPeerEurekaNode(String peerEurekaNodeUrl) {
      if (peerEurekaNodeByUrl.containsKey(peerEurekaNodeUrl)) {
        throw new IllegalStateException(
            "PeerEurekaNode for URL " + peerEurekaNodeUrl + " is already created");
      }
