...
public class RateLimitingFilterTest {
  ...
  public void setUp() throws Exception {
    ...
    ConfigurationManager.getConfigInstance()
        .setProperty("eureka.rateLimiter.privilegedClients", PYTHON_CLIENT);
    ...
    ConfigurationManager.getConfigInstance()
        .setProperty("eureka.rateLimiter.registryFetchAverageRate", 1);
    ConfigurationManager.getConfigInstance()
        .setProperty("eureka.rateLimiter.fullFetchAverageRate", 1);
    ConfigurationManager.getConfigInstance()
        .setProperty("eureka.rateLimiter.throttleStandardClients", false);
  ...
  public void testStandardClientsThrottlingEnforceable() throws Exception {
    ConfigurationManager.getConfigInstance()
        .setProperty("eureka.rateLimiter.throttleStandardClients", true);
    ...
    assertEquals(
        "Expected rate limiter counter increase",
        rateLimiterCounter + 1,
        EurekaMonitors.RATE_LIMITED.getCount());
  ...
  public void testCustomClientThrottlingCandidatesCounter() throws Exception {
    ...
    assertEquals(
        "Expected rate limiter counter increase",
        rateLimiterCounter + 1,
        EurekaMonitors.RATE_LIMITED_CANDIDATES.getCount());
